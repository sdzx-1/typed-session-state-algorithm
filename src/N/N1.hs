...
LABEL 0                                          0                             0                             1
  ...
  [Branch] Seller                                2                             2                             1
    * BranchSt NotFound
    NoBook                                    (2,1)<-                       <-(2,0)                        (1,1)
    SellerNoBook                              (1,0)->                        (0,0)                        ->(1,1)
    ^ Goto 0
    * BranchSt Found
    Price                                     (2,1)<-                       <-(2,3)                        (1,1)
    [Branch] Buyer                               1                             3                             1
      * BranchSt One
      OneAfford                               (1,3)->                        (3,3)                        ->(1,4)
      OneAccept                               (3,5)->                       ->(3,5)                        (4,4)
      OneDate                                 (5,4)<-                       <-(5,0)                        (4,4)
      OneSuccess                              (4,0)->                        (0,0)                        ->(4,1)
      ^ Goto 0
      * BranchSt Two
      PriceToBuyer2                           (1,6)->                        (3,3)                        ->(1,6)
      [Branch] Buyer2                            6                             3                             6
        * BranchSt NotSupport
        NotSupport                            (6,3)<-                        (3,3)                        <-(6,1)
        TwoNotBuy                             (3,0)->                       ->(3,0)                        (1,1)
        ^ Goto 0
        * BranchSt Support
        SupportVal                            (6,3)<-                        (3,3)                        <-(6,7)
        [Branch] Buyer                           3                             3                             7
          * BranchSt Enough
          TwoAccept                           (3,8)->                       ->(3,8)                        (7,7)
          TwoDate                             (8,7)<-                       <-(8,0)                        (7,7)
          TwoSuccess                          (7,0)->                        (0,0)                        ->(7,1)
          ^ Goto 0
          * BranchSt NotEnough
          TwoNotBuy1                          (3,7)->                       ->(3,-1)                       (7,7)
          TwoFailed                           (7,-1)->                      (-1,-1)                       ->(7,-1)
          ~ Terminal
,--------------------CollectBranchDynVal-----------------
fromList [1,2,3,6,7]
,--------------------MsgT-----------------
